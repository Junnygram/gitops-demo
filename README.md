# GitOps Demo
This is used by the [Introduction to GitOps](https://demo-app.com/course/introduction-gitops/) course presented by CloudAcademy.
...
```
helm install flux --set git.url=git@github.com:demo-app/gitops-demo --namespace flux flux/flux --version 1.6.0
```
...
Check to see that the gitops-demo resources have been automatically deployed by Flux into the demo-app namespace within the K8s cluster
